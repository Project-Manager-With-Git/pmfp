...
def clone(argv:Sequence[str])->None:
    ...
    parser.add_argument("-o", "--out", type=str,default=".",help="输出位置")
    parser.add_argument("-m", "--method", type=str,choices=("GET","POST"),default="GET", help="http方法")
    ...
    parser.add_argument("-t", "--payload_type", type=str,choices=("form","json","url"),default="json", help="负载的类型")
